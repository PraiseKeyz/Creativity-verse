...
// PublicOnly wrapper component: redirect authenticated users to /verse/dashboard
const PublicOnly: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  const { isLoggedIn, token } = useAuthStore();
  const isAuth = !!isLoggedIn || !!token;
  if (isAuth) return <Navigate to="/verse/dashboard" replace />;
  return <>{children}</>;
};
...
function Body() {
  ...
  if (UNDER_DEV) {
    const allowedPaths = new Set<string>(["/verse/jobs"]);
  ...
  return (
    <>
      ...
      <Routes>
        ...
        {/**
         * Note: original request asked for a Next.js redirect; this app uses React Router,
         * so we perform a client-side redirect with <Navigate /> instead.
         */}

        {/* Public-only route wrapper: redirect authenticated users to dashboard */}
        {/* Public-only route wrapper: redirect authenticated users to dashboard */}
        <Route
          path="/"
          element={
        ...
        />
        <Route
          path="/resources/blog-management"
          element={
            <PublicOnly>
              <BlogManagement />
            </PublicOnly>
        ...
        <Route
          path="verse"
          element={isLoggedIn ? <MainApp /> : <Navigate to="/signin" />}
        >
          <Route
            path="dashboard"
            element={
              isLoggedIn ? <Dashboard user={user} /> : <Navigate to="/signin" />
            }
          />
          <Route
            path="creo-ai"
          ...
          <Route
            path="portfolio"
            element={isLoggedIn ? <Portfolio /> : <Navigate to="/signin" />}
          />
          <Route
            path="jobs"
            element={isLoggedIn ? <JobsListing /> : <Navigate to="/signin" />}
          />
          <Route
            path="jobs/saved"
            element={isLoggedIn ? <SavedJobs /> : <Navigate to="/signin" />}
          />
          <Route
            path="jobs/:id"
          ...
          <Route
            path="verse-x-jobs"
            element={isLoggedIn ? <VerseXJobs /> : <Navigate to="/signin" />}
          />
          <Route
            path="community"
            element={isLoggedIn ? <Community /> : <Navigate to="/signin" />}
          />
          <Route
            path="contests"
            element={isLoggedIn ? <Contests /> : <Navigate to="/signin" />}
          />
          <Route
            path="webinars"
            element={isLoggedIn ? <Webinars /> : <Navigate to="/signin" />}
          />
          <Route
            path="marketplace"
            element={isLoggedIn ? <Marketplace /> : <Navigate to="/signin" />}
          />
          <Route
            path="talents"
            element={isLoggedIn ? <Talents /> : <Navigate to="/signin" />}
          />
          <Route
            path="product/:id"
          ...
          <Route
            path="feed"
            element={isLoggedIn ? <Feed /> : <Navigate to="/signin" />}
          />
          <Route
            path="settings"
          ...
          <Route
            path="help-center"
            element={isLoggedIn ? <HelpCenter /> : <Navigate to="/signin" />}
          />
          <Route
            path="privacy-policy"
            element={isLoggedIn ? <PrivacyPolicy /> : <Navigate to="/signin" />}
          />
          <Route
            path="elite-lounge"
            element={isLoggedIn ? <CvEliteLounge /> : <Navigate to="/signin" />}
          />
          <Route
            path="my-applications"
            element={
              isLoggedIn ? <UserApplications /> : <Navigate to="/signin" />
            }
          />
          <Route
          ...
          />
          <Route
            path="seller-center/ads-listings"
            element={isLoggedIn ? <AdListings /> : <Navigate to="/signin" />}
          />
          <Route
            path="seller-center/create-job"
            element={isLoggedIn ? <CreateJob /> : <Navigate to="/signin" />}
          />
          <Route
            path="seller-center/edit-job"
            element={isLoggedIn ? <EditJob /> : <Navigate to="/signin" />}
          />
          <Route
            path="seller-center/job-listings"
            element={isLoggedIn ? <JobListings /> : <Navigate to="/signin" />}
          />
          <Route
            path="seller-center/list-product"
            element={
              isLoggedIn ? <CreateProducts /> : <Navigate to="/signin" />
            }
          />
          <Route
            path="seller-center/edit-product"
            element={isLoggedIn ? <EditProduct /> : <Navigate to="/signin" />}
          />
          <Route
            path="seller-center/product-listings"
            element={
          ...
          />
          <Route
            path="skill-lens/onboarding"
            element={isLoggedIn ? <Onboarding /> : <Navigate to="/signin" />}
          />
          <Route
            path="skill-lens/test/:id"
            element={isLoggedIn ? <TestPage /> : <Navigate to="/signin" />}
          />
          <Route
            path="skill-lens/result/:id"
            element={isLoggedIn ? <ResultPage /> : <Navigate to="/signin" />}
          />
        </Route>
